    ...
    user_simulator_config = {
        ...
        "user_llm_args": {
            "provider_settings": {
                ...
                "APIKEY": "upper-compact-api-secret",
                "api_token": "api-token-secret",
                "APIToken": "acronym-api-token-secret",
                "apitoken": "compact-api-token-secret",
                "APITOKEN": "upper-compact-api-token-secret",
                ...
                "AUTHTOKEN": "compact-auth-token-secret",
                ...
                "ACCESSKEY": "compact-access-key-secret",
            },
            "nested": [
                {
                    "max_tokens": 512,
