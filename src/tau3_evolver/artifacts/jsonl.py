...
class JsonlWriter:
    """Append canonical JSON objects without truncating existing events."""
...
# Internal compatibility alias for repository code. It stays in the artifacts module
# so filesystem durability has a single owner.
_fsync_directory = fsync_directory


__all__ = ["JsonlWriter", "fsync_directory", "iter_jsonl_objects"]
